...
public abstract class Player extends WorldObject {
	...
	/* Variables est�ticas que ayudan a reproducir
	 ...
	 * simplemente habr�a que implementar el m�todo
	 * createKeys(void) y en el cuerpo de la funci�n
	 * realizar la asignaci�n de valores. */
	...
	/* Para las im�genes que representan el estado
	 * del sprite. */
	...
	/* Variable que controla la direcci�n que hay que
